...
const requirementStatusresubmit : React.FC = () => {
    return(
        <IonPage>
            <IonToolbar>
            ...
            <IonContent className="scroll-content">
                ...
                <div className="applicationStatus-box1">
                    <p className="applicationStatus-text1">Application Status: <IonText className="applicationStatus1"> RESUBMIT</IonText></p>
                </div>
...
export default requirementStatusresubmit;