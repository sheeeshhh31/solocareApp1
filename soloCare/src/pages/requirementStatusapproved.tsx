...
const requirementStatusapproved : React.FC = () => {
    return (
        <IonPage>
            <IonToolbar>
            ...
            <IonContent className="scroll-content">
                ...
                <div className="applicationStatus-box1">
                    <p className="applicationStatus-text1">Application Status: <IonText className="applicationStatus1"> APPROVED</IonText></p>
                </div>
                                ...
                                <IonGrid>
                                    ...
                                    <IonRow>
                                        <IonCol>
                                            <IonCol>
                                                <IonRow>
                                                    <IonText className="ticketId-date">(date)</IonText>
                                                </IonRow>
                                                <IonRow>
                                        ...
                                        <IonCol>
                                            <IonCol>
                                                <IonRow>
                                                    <IonText className="ticketId-time">(time)</IonText>
                                                </IonRow>
                                                <IonRow>
...
export default requirementStatusapproved;